...
#command STD OUT <cPrint> => FWrite( 1, <cPrint> + hb_eol() )
#command STD ERR <cPrint> [ <qt: QUIT> ] => FWrite( 2, <cPrint> + hb_eol() );ERRORLEVEL(1);IIF( <.qt.> , __Quit() , NIL ) 
#command STD ERR <cPrint> [ <qt: QUIT> <nErrorLevel> ] => FWrite( 2 , <cPrint> + hb_eol()  );ERRORLEVEL( <nErrorLevel> );IIF( <.qt.> , __Quit() , NIL )
