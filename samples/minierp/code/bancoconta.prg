...
BEGIN FORM FrmBancoConta
    ...
    FORM ADD MAP "B" NAME "Text_TipoConta" FIELDNAME "TIPOCONTA" MESSAGE "Tipo" RADIOGROUP WIDTH 20 HEIGHT 4 OPTIONS { "CONTA_CORRENTE" => "Conta Corrente" , "POUPANCA" => "Poupança" }
